...
public class EQQKPSPublicSoap
{
    ...
    public EQQKPSPublicSoap(){}

    public EQQKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public EQQKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EQQExtendedSoapSerializationEnvelope envelope= new EQQExtendedSoapSerializationEnvelope(EQQExtendedSoapSerializationEnvelope.VER11);
