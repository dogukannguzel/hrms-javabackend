...
public class EQQExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(EQQDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new EQQStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static EQQDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EQQDateTimeConverter dateTimeConverter = new EQQStandardDateTimeConverter();

    public EQQExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EQQExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EQQMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EQQHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EQQExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EQQHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
